...
**Data Studio** (devenu Looker Studio) est un outil de Business Intelligence (BI) et de visualisation de données proposé par Google Cloud. Il permet de créer des tableaux de bor# Data Studio
...
---d interactifs et des rapports personnalisés à partir de multiples sources de données.
